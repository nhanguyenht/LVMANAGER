...
Public Class rpt_ReportBillsHuy
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LVManager.rpt_ReportBillsHuy.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_ReportBillsHuy
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_ReportBillsHuy = New rpt_ReportBillsHuy()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class rpt_ReportImport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LVManager.rpt_ReportImport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_ReportImport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_ReportImport = New rpt_ReportImport()
        rpt.Site = Me.Site
        Return rpt
    End Function

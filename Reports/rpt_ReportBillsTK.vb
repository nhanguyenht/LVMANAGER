...
Public Class rpt_ReportBillsTK
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LVManager.rpt_ReportBillsTK.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_ReportBillsTK
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_ReportBillsTK = New rpt_ReportBillsTK()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class rpt_ReportIncome
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LVManager.rpt_ReportIncome.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_ReportIncome
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_ReportIncome = New rpt_ReportIncome()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class rpt_ReportDepts
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LVManager.rpt_ReportDepts.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_ReportDepts
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_ReportDepts = New rpt_ReportDepts()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class rpt_ReportEmployee
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LVManager.rpt_ReportEmployee.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_ReportEmployee
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_ReportEmployee = New rpt_ReportEmployee()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class rpt_MenuGroupItem
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LVManager.rpt_MenuGroupItem.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_MenuGroupItem
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_MenuGroupItem = New rpt_MenuGroupItem()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class rpt_ReportItem
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LVManager.rpt_ReportItem.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_ReportItem
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_ReportItem = New rpt_ReportItem()
        rpt.Site = Me.Site
        Return rpt
    End Function
